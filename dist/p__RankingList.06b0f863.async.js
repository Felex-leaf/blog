        ...
        74524: function (a, i, t) {
            ...
            function m(a) {
                var i = a.children,
                    ...
                    n = a.style,
                    e = a.className,
                    x = (0, r.Z)(a, ['children', 'style', 'className']),
                    m = (0, s.Z)({}, n);
                return (0, l.jsx)(
                    'div',
                    (0, s.Z)(
                        (0, s.Z)({}, x),
                        {},
                        { className: o()([e, k().button]), style: m, children: t },
                    ),
                );
            }
            i['Z'] = (0, n.memo)(m);
        },
        90826: function (a, i, t) {
            'use strict';
            t.r(i),
                t.d(i, {
                    default: function () {
            ...
            class p extends r.Component {
                constructor() {
                    super(...arguments),
                        ...
                        (this.containerRef = (0, r.createRef)()),
                ...
                componentDidMount() {
                    var a = this.props,
                        ...
                        r = a.viewNum,
                        n = a.rankingHeight,
                        e = t - Math.ceil(r / 2) > 0 ? 60 * (t - Math.ceil(r / 2)) : 0,
                        ...
                        setTimeout(() => {
                            ...
                            var e = i.map((i, k) => {
                                ...
                                if (k < t && k >= s) {
                                    ...
                                    l = {
                                        top: 60,
                                        marginBottom: k === t - 1 ? '60px' : '',
                                        duration: a / (t - s),
                                        delay: m,
                                        onStart: (a) => {
                                            var i = a.target,
                                                t = i.getElementsByClassName('rankingNumber')[0];
                                            if (t && ((t.innerText = String(k + 2)), k < 3)) {
                                                var s = i.getElementsByClassName(
                                                    'rankingAward'.concat(k + 1),
                                                )[0];
                                                s && (s.className = 'rankingAward'.concat(k + 2));
                                            }
                                        },
                                    };
                                }
                                        ...
                                        (l = {
                                            ...
                                            onStart: (i) => {
                                                ...
                                                if (e) {
                                                    var o = setInterval(() => {
                                                        e.innerText = String(
                                                            Number(e.innerText) - 1,
                                                        );
                                                    }, n);
                                                    setTimeout(() => {
                                                        if (
                                                            (clearInterval(o),
                                                            (e.innerText = String(s + 1)),
                                                            s < 3)
                                                        ) {
                                                            var a = r.getElementsByClassName(
                                                                'rankingAward'.concat(t + 1),
                                                            )[0];
                                                            a &&
                                                                (a.className =
                                                                    'rankingAward'.concat(s + 1));
                                                        }
                                                    }, a);
                                                }
                                            },
                ...
                componentDidUpdate(a, i) {
                    var t = this.state,
                        s = t.current,
                        r = t.animation;
                    if (i.animation[s] && r[s] && i.animation[s].scale !== r[s].scale) return !0;
                }
                render() {
                    var a = this.props.children,
                        i = this.state,
                        t = i.end,
                        s = i.lottieAnimationStart,
                        r = {
                            loop: !1,
                            autoplay: !0,
                            animationData: m,
            ...
            var d = t(94184),
                        ...
                        f = (0, r.useMemo)(() => {
                            ...
                            return (
                                l < d
                                    ...
                                    : m > g
                                    ? (a = 60 * (m - (m - l)))
                                    : m - (g - l) - 1 >= d && (a = 60 * (m - (g - l) - 1) + u),
                                a
                            );
                        }, [m, d, g, l, u]),
                        v = 56037;
                    return (0, c.jsxs)('div', {
                        className: o().rankingList,
                        children: [
                            (0, c.jsx)('div', {
                                className: o().rankingListTop,
                                children: (0, c.jsx)('span', { children: '\u6392\u884c\u699c' }),
                            }),
                            (0, c.jsxs)('div', {
                                className: o().rankingListContent,
                                children: [
                                    (0, c.jsxs)('div', {
                                        className: o().rankingContentItemNav,
                                        children: [
                                            (0, c.jsx)('div', {
                                                className: o().rankingContentLeft,
                                                children: '\u540d\u6b21',
                                            }),
                                            (0, c.jsx)('div', { style: { flex: 1 } }),
                                            (0, c.jsx)('div', {
                                                className: o().rankingContentCenter,
                                                children: '\u7528\u6237',
                                            }),
                                            (0, c.jsx)('span', {
                                                className: o().rankingContentRight,
                                                children: '\u79ef\u5206\u503c',
                                            }),
                                            (0, c.jsx)('div', { style: { flex: 1 } }),
                                        ],
                                        ...
                                        children: (0, c.jsx)('div', {
                                            ...
                                            children: x.length
                                                ? (0, c.jsx)(p, {
                                                      ...
                                                      children: x.map((a, i) =>
                                                          (0, c.jsxs)('div', {
                                                              className: o().rankingContentItem,
                                                              id: i === h ? 'target' : '',
                                                              style:
                                                                  i === l
                                                                      ? {
                ...
                g = (a) => {
                    ...
                    return (
                        (0, r.useEffect)(() => {}, []),
                        (0, c.jsxs)('div', {
                            className: o().rankingWrap,
                            style: i,
                            children: [
                                (0, c.jsxs)('div', {
                                    className: o().rankingBoardTop,
                                    children: [
                                        (0, c.jsxs)('div', {
                                            className: o().rankingBoardTopLeft,
                                            children: [
                                                (0, c.jsx)('img', {
                                                    alt: '',
                                                    src: t.avatar,
                                                    className: o().rankingBoardAvater,
                                                }),
                                                (0, c.jsx)('span', {
                                                    className: o().rankingBoardName,
                                                    children: t.userName,
                                                }),
                                            ],
                                        }),
                                        (0, c.jsxs)('div', {
                                            className: o().rankingBoardTopRight,
                                            children: [
                                                (0, c.jsx)('span', { className: o().rankingStar }),
                                                (0, c.jsx)('span', {
                                                    className: o().rankingBoardIntegral,
                ...
                v = (a) => {
                    var i = a.onClick,
                        ...
                        s = a.className;
                    return (0, c.jsx)('div', {
                        className: y()([o().socialButton, s]),
                        onClick: i,
                        style: t,
                        children: (0, c.jsxs)('div', {
                            className: o().rankingContent,
                            children: [
                                (0, c.jsxs)('div', {
                                    className: o().rankingIcon,
                                    children: [
                                        (0, c.jsx)('span', { className: o().rankingIconStar }),
                                        (0, c.jsx)('span', {
                                            className: o().rankingIconIntegral,
                                            children: '97',
                                        }),
                                    ],
                                }),
                                (0, c.jsx)('span', { children: '\u6211\u7684\u79ef\u5206' }),
                            ],
                        }),
                    });
                },
            ...
            function S() {
                ...
                return (0, c.jsxs)('div', {
                    className: _().dontRContainer,
                    children: [
                        (0, c.jsxs)('div', {
                            className: _().dontRbuttonWrap,
                            children: [
                                (0, c.jsx)(v, {}),
                                (0, c.jsx)(B.Z, {
                                    style: { marginTop: 10 },
